...
WHERE DISPENSINGDATE >= DATEADD('month', -12, CURRENT_DATE())  -- 12-month filter on DISPENSINGDATE
LIMIT 50000;
...
WHERE ORDERING_DATE >= DATEADD('month', -12, CURRENT_DATE())  -- 12-month filter on ORDERING_DATE
LIMIT 50000;
