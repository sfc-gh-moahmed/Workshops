...
AS (
    ...
    WHERE DRUGDESCRIPTION IS NOT NULL
      AND FIRST_DELIVERYDATE >= DATEADD('month', -12, CURRENT_DATE())
...
-- ML_ENGINEER: mirror search service access
GRANT USAGE ON CORTEX SEARCH SERVICE
    SI_CHOP.CHOP_SNOW_INTELLIGENCE.DRUG_CATALOG_SEARCH TO ROLE ML_ENGINEER;
GRANT USAGE ON CORTEX SEARCH SERVICE
    SI_CHOP.CHOP_SNOW_INTELLIGENCE.PRESCRIPTION_DIRECTIONS_SEARCH TO ROLE ML_ENGINEER;
